...
d3.tsv("data/keyword_vs_pi.tsv", type, function(error, data) {
  x.domain(data.map(function(d) { return d.keywords; }));
  ...
  svg2.append("text")
        ...
        .text("Number of Keywords VS Number of PIs");

  svg2.selectAll(".bar")
      .data(data)
    .enter().append("rect")
      .attr("class", "bar")
      .attr("x", function(d) { return x(d.keywords); })
